 ...
 * generated in the com.caizhidao.jiaoyisuo.aq package. 
...
public class ObjectFactory {
    ...
    private final static QName _OpenAndCheckCheckBankCard_QNAME = new QName("http://impl.service.ta.ctis.com", "checkBankCard");
    ...
    private final static QName _OpenAndCheckBankAcc_QNAME = new QName("http://impl.service.ta.ctis.com", "bankAcc");
    ...
    private final static QName _OpenAndCheckIDType_QNAME = new QName("http://impl.service.ta.ctis.com", "IDType");
    ...
    @XmlElementDecl(namespace = "http://impl.service.ta.ctis.com", name = "checkBankCard", scope = OpenAndCheck.class)
    public JAXBElement<String> createOpenAndCheckCheckBankCard(String value) {
        return new JAXBElement<String>(_OpenAndCheckCheckBankCard_QNAME, String.class, OpenAndCheck.class, value);
    }
    ...
    @XmlElementDecl(namespace = "http://impl.service.ta.ctis.com", name = "bankAcc", scope = OpenAndCheck.class)
    public JAXBElement<String> createOpenAndCheckBankAcc(String value) {
        return new JAXBElement<String>(_OpenAndCheckBankAcc_QNAME, String.class, OpenAndCheck.class, value);
    }
    ...
    @XmlElementDecl(namespace = "http://impl.service.ta.ctis.com", name = "IDType", scope = OpenAndCheck.class)
    public JAXBElement<String> createOpenAndCheckIDType(String value) {
        return new JAXBElement<String>(_OpenAndCheckIDType_QNAME, String.class, OpenAndCheck.class, value);
    }
