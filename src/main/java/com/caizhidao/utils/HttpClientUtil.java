...
import com.caizhidao.utils.HttpClientPoolManager;
...
public class HttpClientUtil {
	...
	public static String doGet(String url, String params, int tryCount,
			long waitingStamp) throws IOException {
		return doGet(url, params, null, tryCount, waitingStamp, null);
	}
