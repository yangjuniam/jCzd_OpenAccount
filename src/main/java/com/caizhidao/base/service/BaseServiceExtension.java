package com.caizhidao.base.service;

import com.caizhidao.base.dao.QueryDaoExtension;
import com.caizhidao.base.model.Page;
import com.caizhidao.base.utils.ReflectUtil;
 ...
 */
public abstract class BaseServiceExtension<T> {

	protected Class<T> entityClass;

	@Autowired
	protected QueryDaoExtension queryDao;

	@SuppressWarnings("unchecked")
	public BaseServiceExtension() {
	...
	public List<T> selectByPage(String sqlId, Page page) {
		...
		// return this.queryDao.getSqlSession().selectList(sqlId(sqlId), page,
		// new RowBounds(page.getPageNo() * page.getPageSize(),
		// page.getPageSize()));
	}
